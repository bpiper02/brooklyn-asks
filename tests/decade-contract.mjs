...
const clarity = readFileSync(new URL('../public/clarity.js', import.meta.url), 'utf8');
...
assert.doesNotMatch(clarity, /enhanceHistory|coverage-year|source-year-card/, 'clarity.js must not rewrite the Decade page');
